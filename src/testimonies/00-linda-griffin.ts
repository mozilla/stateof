export const content: object = {
  ...
  modal_style: "medium",
  excerpt:
    "<blockquote>Our aim is not just to develop products that people can trust but to build movements that give voice to the views of those people.</blockquote>",
