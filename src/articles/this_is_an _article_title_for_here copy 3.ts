export const content: object = {
  ...
  lead_article: false,
  modal_style: 'short',
  icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 293 293"><path fill="#FFB39A" d="M95 0h198v193H95z" opacity=".5"/><path fill="#FFB39A" d="M0 108h190v185H0z"/></svg>',
  width: 'third',
